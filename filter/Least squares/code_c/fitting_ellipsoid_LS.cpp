 ...
 *	@最小二乘椭球拟合
 *
 *  @refer：https://zhuanlan.zhihu.com/p/37265316
 *
 *		((x-xo)/A)^2 + ((y-yo)/B)^2 + ((z-zo)/C)^2 = 1
 *
 *      x^2 + a*y^2 +b*z^2 + c*x + d*y + e*z + f = 0
 *
 *      param: a b c d e f
 *
 *		ei(a,b,c,d,e,f) = x^2 + a*y^2 +b*z^2 + c*x + d*y + e*z + f
 *
 *		E(a,b,c,d,e,f) = e0(a,b,c,d,e,f)^2 + e1(a,b,c,d,e,f)^2 + ... + e(k-1)(a,b,c,d,e,f)^2
 *
 *		
 */
